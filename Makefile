...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed May 22 09:26:16 2013
# Project:  client.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/client1.0.0/ && $(COPY_FILE) --parents client.h net.h .tmp/client1.0.0/ && $(COPY_FILE) --parents main.cpp client.cpp net.cpp arp.cpp arp_attack.cpp eth_arp_show.cpp .tmp/client1.0.0/ && (cd `dirname .tmp/client1.0.0` && $(TAR) client1.0.0.tar client1.0.0 && $(COMPRESS) client1.0.0.tar) && $(MOVE) `dirname .tmp/client1.0.0`/client1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/client1.0.0
